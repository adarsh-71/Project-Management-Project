...
if (strlen($_SESSION['etmsaid']==0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($query->rowCount() > 0) {
      echo "<script>alert('Employee Id or Email or Contact number already registered with another employee');</script>";
    } else {
      if (!in_array($extension, $allowed_extensions)) {
        ...
        $sql = "INSERT INTO tblemployee(DepartmentID, EmpId, EmpName, EmpEmail, EmpContactNumber, Designation, EmpDateofbirth, EmpAddress, EmpDateofjoining, Description, Password, ProfilePic, EmpType, EmpNationality) VALUES (:deptname, :empid, :empname, :empemail, :empcontno, :designation, :empdob, :empadd, :empdoj, :desc, :password, :pic, :emptype, :empnationality)";
        $query = $dbh->prepare($sql);
        ...
        $query->bindParam(':empnationality', $empnationality, PDO::PARAM_STR);
        $query->execute();
                              ...
                              <div class="full progress_bar_inner">
                                ...
                                <fieldset>
                                  ...
                                  <div class="field">
                                    ...
                                    <input type="text" name="emptype" value="" class="form-control" required='true'>
                                  </div>
                                  <br>
                                  <div class="field">
                                  ...
                                  <div class="field">
                                    ...
                                    <input type="text" name="empnationality" value="" class="form-control" required='true'>
                                  </div>
                                  <br>
                                  <div class="field">
