...
{               ?> 
                                          <tr>
                                             ...
                                             <td><a href="view-employee.php?viewid=<?php echo htmlentities ($row->eid);?>" class="btn btn-success">View</a>
                                             <a href="edit-employee.php?editid=<?php echo htmlentities ($row->eid);?>" class="btn btn-primary">Edit</a>
